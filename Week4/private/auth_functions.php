<?php
  ...
  function log_in_user($user) {
    ...
    $_SESSION['user_id'] = $user['id']; // TODO Store user's ID in session
    $_SESSION['user_agent'] = $_SERVER['HTTP_USER_AGENT'];    // Store user-agent string (browser type)
    $_SESSION['last_login'] = time(); // TODO Store last login time in session
    return true;
  }
